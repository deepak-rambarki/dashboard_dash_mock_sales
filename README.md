...
## Initial Creator
This project was originally developed by [Chakrit Thong Ek](https://github.com/thongekchakrit).

## Current Maintainer
[Deepak Rambarki](https://www.linkedin.com/in/rambarki-deepak/)
Email: deepakrambarki@gmail.com

## About the Maintainer
Deepak Rambarki is an experienced Data Engineer with over 4 years of expertise in designing scalable data pipelines and analytics solutions. He is proficient in Python, SQL, Spark, and cloud platforms, with a focus on optimizing data architecture and supporting advanced analytics initiatives.
